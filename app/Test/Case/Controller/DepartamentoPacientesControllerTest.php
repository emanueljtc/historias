<?php
App::uses('DepartamentoPacientesController', 'Controller');

/**
 * DepartamentoPacientesController Test Case
 *
 */
class DepartamentoPacientesControllerTest extends ControllerTestCase {
